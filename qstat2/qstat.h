...
#define TRIBES2_SERVER (1<<24)
#define TRIBES2_MASTER ((1<<25)|MASTER_SERVER)
#define DESCENT3_GAMESPY_SERVER (1<<26)
#define DESCENT3_PXO_SERVER (1<<27)
#define DESCENT3_SERVER (1<<28)
#define DESCENT3_MASTER ((1<<29)|MASTER_SERVER)
...
char *q3_masterquery_default_version= "48";
